...
#ifndef UNTITLED2_Idiot_H
#define UNTITLED2_Idiot_H
...
//                !index_memory->Read(cur.children[index + 1], cur);
    ...
    public:
        ...
        private:
            Key key;
            Info info;
            IdiotTree<Key, Info, max_key_num, max_rcd_num, KeyCompare> *this_bpt = nullptr;
            ...
            bool at_end = false;
        public:
            iterator(IdiotTree<Key, Info, max_key_num, max_rcd_num, KeyCompare> *bpt) {
                this_bpt = bpt;
            }
            ...
            friend IdiotTree<Key, Info, max_key_num, max_rcd_num, KeyCompare>::iterator
            IdiotTree<Key, Info, max_key_num, max_rcd_num, KeyCompare>::FindBigger(const Key &wanted);
